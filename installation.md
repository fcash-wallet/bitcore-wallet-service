...
```
### Configuration
Configuration for all required modules can be specified in https://github.com/fcash-wallet/fcash-wallet-service/blob/master/config.js
